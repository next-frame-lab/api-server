...
public interface PerformanceRepository extends JpaRepository<Performance, UUID> {
	 ...
	 */
	@Query(value = """
		    SELECT new wisoft.nextframe.schedulereservationticketing.dto.performancelist.PerformanceSummaryDto(
		        p.id,
		        p.name,
		        p.imageUrl,
		        p.type,
		...
		""")
	Page<PerformanceSummaryDto> findReservablePerformances(Pageable pageable);
}
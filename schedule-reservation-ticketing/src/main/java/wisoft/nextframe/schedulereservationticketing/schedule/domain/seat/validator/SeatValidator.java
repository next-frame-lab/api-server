package wisoft.nextframe.schedulereservationticketing.schedule.domain.seat.validator;

import java.util.Set;

import wisoft.nextframe.schedulereservationticketing.schedule.domain.seat.Seat;
import wisoft.nextframe.schedulereservationticketing.schedule.domain.seat.exception.InvalidSeatForStadiumException;
import wisoft.nextframe.schedulereservationticketing.schedule.domain.seat.exception.NoSeatSelectedException;
import wisoft.nextframe.schedulereservationticketing.schedule.domain.seat.exception.SeatAlreadyLockedException;
import wisoft.nextframe.schedulereservationticketing.schedule.domain.seat.exception.TooManySeatsSelectedException;

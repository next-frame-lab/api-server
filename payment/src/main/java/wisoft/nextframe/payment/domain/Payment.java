...
import wisoft.nextframe.payment.domain.exception.MissingReservationException;
import wisoft.nextframe.payment.domain.exception.PaymentAlreadySucceededException;
import wisoft.nextframe.payment.domain.exception.TooLargeAmountException;

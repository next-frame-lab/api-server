...
import wisoft.nextframe.payment.application.payment.outbox.ticketissue.TicketIssueOutboxRepository;
import wisoft.nextframe.payment.application.payment.outbox.ticketissue.TicketIssueOutboxTarget;
...
public class TicketIssueOutboxRepositoryImpl implements TicketIssueOutboxRepository {
	...
	@Override
	public List<TicketIssueOutboxTarget> findTargets(LocalDateTime now, int limit) {

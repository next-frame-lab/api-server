...
import wisoft.nextframe.schedule.domain.schedule.ReservablePeriod;
import wisoft.nextframe.schedule.domain.schedule.Schedule;
import wisoft.nextframe.schedule.domain.schedule.exception.SeatSectionNotDefinedException;
